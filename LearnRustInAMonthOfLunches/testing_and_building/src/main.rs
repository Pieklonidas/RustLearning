...
mod print_things {
    ...
    pub fn print_one_thing<T: Display>(input: T) {
        println!("{input}");
    }
    ...
    impl Billy {
        pub fn new(times_to_print: u32) -> Self {
            Billy { name: "Billy".to_string(), times_to_print }
        }
...
mod country {
    ...
    pub mod province {
        fn printr_province(province: &str) {
        ...
        pub mod city {
            pub fn print_city(country: &str, province: &str, city: &str) {
                ...
                crate::country::province::printr_province(province);
                super::printr_province(province);
...
fn main() {
    ...
    print_one_thing(6);
    print_one_thing("Trying to print a string...".to_string());
